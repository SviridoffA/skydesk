...
for ($i=0;$i<$num;$i++) {
  ...
  echo "<tr><td>$k</td><td><a href=https://91.223.48.25:9443/admin/index.cgi?index=15&UID=$uid target=_blank>$uid $fio $address</a></td><td>$registration</td><td>$metr</td><td>$metr_digit</td><td>$vols</td><td>$vols_digit</td><td>$descr</td><td>$total</td></tr>";
