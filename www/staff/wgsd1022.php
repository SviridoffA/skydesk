...
class wgsd1022 extends switchoid {
...
// oid for get mac address and port from witch
   ...
   private $tftp = "10.90.90.4";

// community
   public $community='tenretni';
...
// type file (Value = (1: opcode), (2: config), (3: bootRom), (5: loader))
      snmpset($ip,$this->community,"1.3.6.1.4.1.259.6.10.94.1.24.1.5.0","integer",2);

// source type (Values = (1: file), (2: runningCfg), (3: startUpCfg), (4: tftp), (5: unit), (6: http))
      snmpset($ip,$this->community,"1.3.6.1.4.1.259.6.10.94.1.24.1.1.0","integer",2);

// source file (Value = ES3528_52M_opcode_V1.1.3.8.bix)
//    snmpset($ip,$this->community,"1.3.6.1.4.1.259.6.10.94.1.24.1.2.0","string","");

// destanation file Values = (1: file), (2: runningCfg), (3: startUpCfg), (4: tftp), (5: unit), (6: http)
      snmpset($ip,$this->community,"1.3.6.1.4.1.259.6.10.94.1.24.1.3.0","integer",4);

      snmpset($ip,$this->community,"1.3.6.1.4.1.259.6.10.94.1.24.1.6.0","address",$tftp);
      snmpset($ip,$this->community,"1.3.6.1.4.1.259.6.10.94.1.24.1.4.0","string",$file);
      snmpset($ip,$this->community,"1.3.6.1.4.1.259.6.10.94.1.24.1.8.0","integer",2);
...
//     $speed=$this->speedport($ip,$port);
     ...
     $str=$str."Target[".$ip."_$port]: $port:".$this->community."@$ip\n";
