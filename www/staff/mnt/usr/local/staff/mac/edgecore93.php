...
$switch="10.90.89.93";
$cmd="/usr/local/bin/snmpwalk -v 1 -c tenretni -O n $switch 1.3.6.1.2.1.17.4.3.1.2";
$pp=popen($cmd,"r");
while (!feof($pp)) {
  $str=trim(fgets($pp,1024));
  if (strlen($str) > 2 ) {
  
// группа OID: 1.3.6.1.2.1.17.4.3.1
// 1.3.6.1.2.1.17.4.3.1.1 : show mac-address
// 1.3.6.1.2.1.17.4.3.1.2 : show mac-address interface
// 1.3.6.1.2.1.17.4.3.1.3 : show mac-address type 
