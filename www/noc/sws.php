...
$sport="a";
$community="public";
$stype="D-Link DES-3200-18 Fast Ethernet Switch";
...
$stype=trim(info($switch,$community));
...
//  echo "</pre>";
  ...
  for ($i=0;$i<$num;$i++) {
      ...
      $str=sprintf("<tr><td>%d</td><td><a href=mac.php3?mac=%s>%s</a></td><td>%15s</td><td></td><td></td></tr>",$port,$mac,$mac,$ip); 
      echo $str;
