...
function save_mac($mac,$switch,$port) {
  $query="select * from switchmac where mac like '$mac' and ipswitch like '$switch'  order by cdate desc";
//  echo "$query\n";
...
//      echo "$query\n";
      ...
      $query="update switchmac set cdate=now() where id like '$id' and mac like '$mac' and ipswitch like '$switch' and port like '$port'";
      $res=mysql("sky_switch",$query);
//      echo "$query\n";
      echo mysql_error();
